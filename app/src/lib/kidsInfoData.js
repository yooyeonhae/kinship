...
// 3-1. 오늘의 고사성어 (Hanja Idioms)
export const HANJA_IDIOMS = [
  {
    id: 'hi1',
    word: '일석이조',
    hanja: '一石二鳥',
    pronunciation: '일석이조',
    meaning: '돌 하나를 던져 두 마리의 새를 잡는다는 뜻으로, 한 가지 일로 두 가지 이득을 얻음',
    example: '도서관에 가서 책도 읽고 방학 숙제도 마쳤으니 완전 일석이조야!',
  },
  {
    id: 'hi2',
    word: '고진감래',
    hanja: '苦盡甘來',
    pronunciation: '고진감래',
    meaning: '쓴맛이 다하면 단맛이 온다는 뜻으로, 힘든 고생 끝에는 즐거움이 찾아옴',
    example: '매일 열심히 연습하더니 드디어 줄넘기 100개를 넘겼구나. 고진감래야!',
  },
  {
    id: 'hi3',
    word: '대기만성',
    hanja: '大器晩成',
    pronunciation: '대기만성',
    meaning: '큰 그릇은 늦게 이루어진다는 뜻으로, 큰 인물은 오랜 노력과 시간을 거쳐 완성됨',
    example: '지금 당장 서툴러도 괜찮아. 대기만성처럼 꾸준히 노력하면 멋진 꿈을 이룰 수 있어.',
  },
  {
    id: 'hi4',
    word: '칠전팔기',
    hanja: '七顚八起',
    pronunciation: '칠전팔기',
    meaning: '일곱 번 넘어져도 여덟 번 일어난다는 뜻으로, 여러 번 실패해도 굽히지 않고 다시 도전함',
    example: '자전거를 타다 몇 번 넘어져도 칠전팔기 정신으로 다시 일어나 배웠어요.',
  },
  {
    id: 'hi5',
    word: '유비무환',
    hanja: '有備無患',
    pronunciation: '유비무환',
    meaning: '미리 준비해 두면 나중에 근심이나 걱정이 없다는 뜻',
    example: '내일 소풍 갈 때 비가 올지 모르니 작은 우산을 챙기는 유비무환의 자세가 필요해.',
  },
  {
    id: 'hi6',
    word: '온고지신',
    hanja: '溫故知新',
    pronunciation: '온고지신',
    meaning: '옛것을 익혀서 그것을 미루어 새로운 지식이나 도리를 안다는 뜻',
    example: '우리 조상님들의 지혜를 온고지신 삼아 새로운 발명을 할 수 있어요.',
  },
]

// 3-2. 오늘의 우리 속담 (Korean Proverbs)
export const PROVERBS = [
  {
    id: 'pr1',
    word: '티끌 모아 태산',
    pronunciation: '티끌 모아 태산',
    meaning: '아무리 작은 것이라도 모이고 모이면 나중에 큰 덩어리가 된다는 뜻',
    example: '매일 백 원씩 저금통에 모았더니 어느새 티끌 모아 태산이 되었어요.',
  },
  {
    id: 'pr2',
    word: '가는 말이 고와야 오는 말이 곱다',
    pronunciation: '가는 말이 고와야 오는 말이 곱다',
    meaning: '내가 남에게 말이나 행동을 곱게 해야 남도 나에게 곱게 대한다는 뜻',
    example: '친구에게 먼저 다정하게 말을 건네보세요. 가는 말이 고와야 오는 말이 고우니까요.',
  },
  {
    id: 'pr3',
    word: '발 없는 말이 천 리 간다',
    pronunciation: '발 없는 말이 천 리 간다',
    meaning: '말은 발이 없지만 눈 깜짝할 사이에 널리 퍼지므로 늘 말조심해야 한다는 뜻',
    example: '소문은 발 없는 말이 천 리를 가니, 다른 사람의 흉을 보지 않도록 조심해요.',
  },
  {
    id: 'pr4',
    word: '백지장도 맞들면 낫다',
    pronunciation: '백지장도 맞들면 낫다',
    meaning: '아무리 쉬운 일이라도 서로 힘을 합치면 훨씬 쉽고 빠르게 해낼 수 있다는 뜻',
    example: '동생과 함께 장난감을 정리하니 백지장도 맞들면 낫다는 말이 딱 맞았어요.',
  },
  {
    id: 'pr5',
    word: '시작이 반이다',
    pronunciation: '시작이 반이다',
    meaning: '무슨 일이든 처음 시작하기가 어렵지, 일단 시작하고 나면 절반은 끝낸 것이나 다름없다는 뜻',
    example: '방 청소가 막막했는데 책상부터 치우기 시작하니 벌써 시작이 반이네요!',
  },
  {
    id: 'pr6',
    word: '호랑이도 제 말 하면 온다',
    pronunciation: '호랑이도 제 말 하면 온다',
    meaning: '남의 이야기를 하고 있을 때 마침 그 사람이 나타난다는 뜻',
    example: '방금 민수 이야기하고 있었는데 교실 문을 열고 들어오네! 호랑이도 제 말 하면 온다더니.',
  },
]
